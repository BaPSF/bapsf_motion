...
#  Note: If bapsf_motion.__version__ can not be defined then it is set to 'unknown'.
...
htmlhelp_basename = "bapsf_motiondoc"
...
.. raw:: html
    ...
    <div class="admonition note">
      <p style="margin-bottom:0px">
        ...
        <a class="reference external" href="https://github.com/BaPSF/bapsf_motion/{{ nb_base|e }}/{{ nb_where|e }}/{{ docname|e }}">{{ docname|e }}</a>.
      </p>
    </div>
